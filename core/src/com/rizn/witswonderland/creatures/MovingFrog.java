...
package com.rizn.witswonderland.creatures;

import com.badlogic.gdx.math.Rectangle;
import com.badlogic.gdx.math.Vector2;
import com.rizn.witswonderland.Bob;
import com.rizn.witswonderland.Map;
...
public class MovingFrog {
    ...
    public static final float FORWARD_VEL = 4;
    public static final float BACKWARD_VEL = 4;
    ...
    public MovingFrog(Map map, float x, float y) {
        this.map = map;
        pos.x = x;
        pos.y = y;
        bounds.x = x;
